...
void GridGraph::removePoint(const IntPair& p1) {
  ...
  // TODO: Your code here!
  // =======================================================================
  for(auto &item: originalNeighbors){
    adjacencyMap[item].erase(p1);
  }
  ...
  // TODO: Your code here!
  // =======================================================================
  for(auto removePoint = adjacencyMap.begin(); removePoint != adjacencyMap.end();){
    if(removePoint->first == p1){
      removePoint = adjacencyMap.erase(removePoint);
      break;
    } else {
      removePoint++;
    }
